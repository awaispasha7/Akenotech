        ...
        <div className="w-full max-w-2xl mx-auto">
            <div className="glass rounded-2xl p-8">
                ...
                <div className="relative h-4 bg-gray-700 rounded-full overflow-hidden mb-4">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-emerald-500 via-emerald-400 to-teal-400 
                ...
                <div className="mt-8 grid grid-cols-4 gap-2">
                  ...
                  ${progress >= stage.threshold ? 'bg-emerald-500' : 'bg-gray-700'}
                `}
                            />
                            <span className={`
                text-xs transition-colors duration-300
                ${progress >= stage.threshold ? 'text-emerald-400' : 'text-gray-500'}
              `}>
                                {stage.label}
                            </span>
                        </div>
