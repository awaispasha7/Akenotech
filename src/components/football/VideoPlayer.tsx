    ...
    return (
        <div className="w-full max-w-4xl mx-auto">
            <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl flex items-center space-x-3">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-emerald-400">Processing Complete!</h3>
                ...
                <div className="p-4 space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            <button
                                onClick={handlePlayPause}
                                className="p-3 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-white transition-colors"
                            >
                                {isPlaying ? (
