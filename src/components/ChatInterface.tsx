...
**Ready to transform your business with AI? Let's chat!**`;
  ...
  return (
    <>
      ...
      {/* Chat Interface */}
      <div className="fixed top-16 sm:top-20 left-2 right-2 sm:left-auto sm:right-4 md:right-8 bottom-4 sm:bottom-16 z-50 w-[calc(100%-1rem)] sm:w-96 md:w-[28rem] max-h-[calc(100vh-5rem)] sm:max-h-[calc(100vh-9rem)] flex flex-col animate-in slide-in-from-right-5 duration-300 max-w-full">
        {/* Chat Window */}
