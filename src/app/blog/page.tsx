...
export default function BlogPage(): React.JSX.Element {
  ...
  const handleDeletePost = async (postId: string) => {
    ...
    if (window.confirm('Are you sure you want to delete this blog post? This action cannot be undone.')) {
      try {
        await deleteBlogPost(postId, user.uid, userIsAdmin);
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8 px-4">
              {user ? (
                <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto">
                  <div className="text-sm sm:text-base text-gray-300 text-center sm:text-left">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2.5 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-all text-sm min-h-[44px] touch-manipulation"
                  >
                    Sign Out
                  </button>
                </div>
