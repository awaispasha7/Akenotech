    ...
    <div className="min-h-screen bg-[#050816] text-white flex flex-col">
      ...
      <main className="flex-1 pt-28 pb-16">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 space-y-10">
          <header className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <button
                ...
                className="inline-flex items-center justify-center border-2 border-emerald-400/50 text-emerald-300 px-6 py-3 rounded-full font-semibold text-sm hover:bg-emerald-400/10 hover:border-emerald-400 transition-all"
              >
                View Examples
              </button>
            </div>
          ...
          {!authLoading && (
            <div className="bg-white/5 border border-white/15 rounded-xl p-4 sm:p-6">
              {user ? (
                ...
                <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                  <div className="flex-1">
                    ...
                    <select
                      ...
                      disabled={isBusy}
                    >
                      <option value="10" className="bg-[#050816] text-white">10 seconds</option>
                      <option value="15" className="bg-[#050816] text-white">15 seconds</option>
                    </select>
                  </div>
          ...
          {status === "waiting" && (
            <section>
              <div className="bg-black/40 border border-white/15 rounded-2xl p-6 flex items-center gap-4">
                <div className="w-8 h-8 border-4 border-white/30 border-t-emerald-400 rounded-full animate-spin shrink-0" />
                <div className="flex-1">
      ...
      {showExamples && (
        ...
        >
          <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl sm:rounded-3xl max-w-6xl w-full max-h-[95vh] overflow-y-auto border border-gray-700/50 relative shadow-2xl shadow-purple-500/20 animate-in zoom-in-95 duration-300">
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-br from-purple-600/5 via-blue-600/3 to-teal-600/5 rounded-2xl sm:rounded-3xl pointer-events-none"></div>
            ...
            <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-50">
              <button
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-800/80 hover:bg-gray-700/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer touch-manipulation"
            ...
            <div className="p-4 sm:p-6 md:p-10 relative z-10">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 sm:mb-8 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
                Generated Video Examples
              </h2>

              {loadingExamples ? (
                <div className="flex items-center justify-center py-12 sm:py-20">
                  <div className="w-8 h-8 border-4 border-white/30 border-t-emerald-400 rounded-full animate-spin"></div>
                </div>
              ) : exampleVideos.length === 0 ? (
                <div className="text-center py-12 sm:py-20 text-white/60">
                  <p className="text-base sm:text-lg">No example videos yet.</p>
                  <p className="text-xs sm:text-sm mt-2">Generate your first video to see it here!</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {exampleVideos.map((video) => (
                    <div
                      ...
                      className="bg-white/5 border border-white/10 rounded-xl p-4 hover:bg-white/10 hover:border-emerald-400/50 transition-all cursor-pointer group"
                    >
      ...
      {selectedVideo && (
        <div 
          className="fixed inset-0 bg-black/95 backdrop-blur-md z-[60] flex items-center justify-center p-4 animate-in fade-in duration-300"
          onClick={(e) => {
            if (e.target === e.currentTarget) {
              setSelectedVideo(null);
            }
        ...
        >
          <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl max-w-4xl w-full max-h-[95vh] overflow-y-auto border border-gray-700/50 relative shadow-2xl shadow-purple-500/20 animate-in zoom-in-95 duration-300">
            {/* Close Button */}
