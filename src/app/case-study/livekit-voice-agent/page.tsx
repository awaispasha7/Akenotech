  ...
  const handleSubmit = useCallback(async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      console.log('Document written with ID: ', docRef.id);
        ...
        // Open the Livekit Voice Agent PDF in a new tab
        window.open('/Voice assistant.pdf', '_blank');
      ...
      try {
        ...
        const templateParams = {
          ...
          company: 'Livekit Voice Agent Case Study Download',
          message: `Case Study Download Details:
          
Name: ${formData.firstName} ${formData.lastName}
Email: ${formData.email}
Phone: ${formData.phone}
Case Study: Livekit Voice Agent
Downloaded At: ${new Date().toLocaleString()}

This user has downloaded the Livekit Voice Agent case study and their information has been saved to Firebase.`
        };
        ...
        <nav className="bg-gray-900 border-b border-gray-700 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              />
              <span className="text-xl font-semibold text-white">Akeno Tech</span>
            </div>
            <button 
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className={`space-y-8 transition-all duration-1000 transform ${
              ...
              <div>
                <h1 className="text-3xl font-bold text-white mb-4">Livekit Voice Agent</h1>
                <p className="text-base text-gray-300 mb-4 leading-relaxed">
                  AI-powered voice assistant that provides intelligent customer support through natural conversation.
                </p>
                <p className="text-base text-gray-300 mb-4 leading-relaxed">
                  Handles complex queries, provides instant responses, and escalates to human agents when needed.
                </p>
                <p className="text-base text-gray-300 mb-4 leading-relaxed">
                ...
                <ul className="space-y-2 text-gray-300 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-sm">Voice recognition and processing</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-sm">Real-time conversation management</span>
                  </li>
                  <li className="flex items-start">
            ...
            <div className={`transition-all duration-1000 delay-300 transform ${
              ...
              <div className="group relative bg-gray-900 rounded-3xl p-10 border border-gray-800 hover:border-gray-700 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20 hover:scale-[1.02] overflow-hidden w-full max-w-2xl mx-auto">
                ...
                {/* Livekit Voice Agent Image at top of form with better spacing */}
                <div className="mb-8">
                  <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden shadow-lg">
                    <Image 
                      src="/alive1.jpg" 
                      alt="Livekit Voice Agent Logo" 
                      width={400}
                      height={200}
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="text-white">
                        <div className="font-bold text-xl tracking-wide">LIVEKIT VOICE AGENT</div>
                      </div>
                    </div>
                  </div>
                  <h2 className="text-white text-2xl font-bold mb-6 leading-tight">
                    Transform Your Customer Support With AI-Powered Voice
                  </h2>
                  <div className="flex items-center justify-end">
                    <div className="text-white text-right">
                      <div className="text-sm opacity-90 font-medium">AI-Powered Voice Support</div>
                    </div>
                  </div>
                </div>
