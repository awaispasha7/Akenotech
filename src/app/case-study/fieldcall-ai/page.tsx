  ...
  const handleSubmit = useCallback(async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      console.log('Document written with ID: ', docRef.id);
        ...
        // Open the FieldCall PDF in a new tab
        window.open('/field call.pdf', '_blank');
      ...
      try {
        ...
        const templateParams = {
          ...
          company: 'FieldCall.ai Case Study Download',
          message: `Case Study Download Details:
          
Name: ${formData.firstName} ${formData.lastName}
Email: ${formData.email}
Phone: ${formData.phone}
Case Study: FieldCall.ai
Downloaded At: ${new Date().toLocaleString()}

This user has downloaded the FieldCall.ai case study and their information has been saved to Firebase.`
        };
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className={`space-y-8 transition-all duration-1000 transform ${
              ...
              <div>
                <h1 className="text-3xl font-bold text-white mb-4">FieldCall</h1>
                <p className="text-base text-gray-300 mb-4 leading-relaxed">
                  AI-powered field service management platform that optimizes technician dispatch, route planning, and customer communication.
                </p>
                <p className="text-base text-gray-300 mb-4 leading-relaxed">
                  Automates scheduling, provides real-time updates, and ensures efficient service delivery across multiple locations.
                </p>
                <p className="text-base text-gray-300 mb-4 leading-relaxed">
                ...
                <ul className="space-y-2 text-gray-300 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-sm">AI-powered dispatch optimization</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-sm">Real-time route planning</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-sm">Customer communication automation</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <div className={`transition-all duration-1000 delay-300 transform ${
              ...
              <div className="group relative bg-gray-900 rounded-3xl p-10 border border-gray-800 hover:border-gray-700 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20 hover:scale-[1.02] overflow-hidden w-full max-w-2xl mx-auto">
                ...
                {/* FieldCall Image at top of form with better spacing */}
                <div className="mb-8">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="text-white">
                        <div className="font-bold text-xl tracking-wide">FIELDCALL.AI</div>
                      </div>
                    </div>
                  </div>
                  <h2 className="text-white text-2xl font-bold mb-6 leading-tight">
                    Transform Your Field Service With The Power Of AI
                  </h2>
                  <div className="flex items-center justify-end">
                    <div className="text-white text-right">
                      <div className="text-sm opacity-90 font-medium">AI-Powered Field Service</div>
                    </div>
                  </div>
                </div>
