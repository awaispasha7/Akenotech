          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className={`lg:col-span-1 transition-all duration-1000 transform ${
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.youtube.com/@akenotech" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-red-600 transition-all duration-300 group hover:scale-110 hover:rotate-3 relative overflow-hidden">
