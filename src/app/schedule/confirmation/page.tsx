...
// Mark this page as dynamic to prevent static generation issues with useSearchParams
...
function ConfirmationContent() {
  ...
  return (
    <div className="relative w-full max-w-2xl">
        ...
        {/* Confirmation Card */}
        <div className={`bg-[#0a0a0a]/80 rounded-2xl border border-[#1a1a1a]/50 shadow-2xl p-8 transition-all duration-1000 transform ${
          ...
          <div className="text-center space-y-4">
            ...
            <div className="bg-[#1a1a1a]/60 rounded-lg p-6 border border-[#2a2a2a] space-y-3">
              ...
              {(date || time) && (
                <div className="pt-4 border-t border-[#2a2a2a]">
                  ...
                  {date && (
                    <p className="text-white font-semibold">📅 Date: {formatDate(date)}</p>
                  )}
                  {time && (
                    <p className="text-white font-semibold">🕐 Time: {time}</p>
                  )}
                </div>
              )}
            </div>
            ...
            <div className="pt-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <button
                  onClick={() => router.push('/schedule')}
                  className="px-6 py-3 bg-gradient-to-r from-[#2a2a2a] to-[#3a3a3a] hover:from-[#3a3a3a] hover:to-[#4a4a4a] text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02]"
                >
                  Schedule Another
                </button>
                <button
                  onClick={() => router.push('/')}
                  className="px-6 py-3 bg-transparent border border-[#2a2a2a] hover:border-[#3a3a3a] text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02]"
                >
                  Back to Home
                </button>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-[#2a2a2a]/50">
            <div className="text-center">
              <h4 className="text-lg font-semibold text-white mb-4">📞 Need to Make Changes?</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span><strong>Email:</strong> ask@akenotech.com</span>
                </div>
              </div>
